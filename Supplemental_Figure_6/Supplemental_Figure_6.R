...
BacSCP_data <- read_delim(
  "data/SC_protein_table_sup_fig_6.tsv",
  delim = "\t"
)

bulk200ng_data <- read_delim(
  "data/bulk_protein_table_sup_fig_6.tsv",
  delim = "\t"
)
...
# Supplemental Figure 6 B: 50°C — WITHOUT contaminants ----
...
# Supplemental Figure 6 A: 37 °C — WITHOUT contaminants ----
