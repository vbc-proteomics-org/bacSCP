...
BacSCP_data <- read_delim("data/protein_table_fig6.tsv", delim = "\t")
...
target_genes <- c("trypsin", "clpC", "groEL", "groES", "ctc", "pgk")
...
genes_of_interest <- c("clpC", "groES", "groEL", "ctc", "pgk")
grey_genes <- c("ctc", "pgk")
